...
<body>
    ...
    <form action='asmap_register.php' class='bg-black p-4 text-white rounded-lg opacity-70 flex flex-col'>
        <label>name</label>
        <input type='text' name='map_name' class='bg-white p-2 text-black rounded-lg opacity-70 flex flex-col'><br>
        <label>description</label>
        <input type='text' name='map_desc' class='bg-white p-2 text-black rounded-lg opacity-70 flex flex-col'><br> 
         
        <h1 class='bg-black p-2  rounded-lg opacity-70 flex flex-col'><br> 
