...
<body>
    ...
    echo"
        ...
        <a href='ascharacter_remover2.php?id_chara=$id_chara' class='bg-white p-4 text-black rounded-lg opacity-70 flex flex-col'> 
        <p> YES I AM SURE!</p>
        </a>
        <a href='aschar.php' class='bg-white p-4 text-black rounded-lg opacity-70 flex flex-col'>
