...
CREATE TABLE `backlog_tournament` (
  ...
  `bktournament_start` datetime,
  `bktournament_end` datetime
);
...
CREATE TABLE `backlog_character` (
  ...
  `chara_ws` char(4),
  `chara_rs` char(4),
  `chara_primary` varchar(30),
  `chara_secondary` varchar(30),
  `chara_desc` varchar(60),
  `chara_lore` varchar(65365)
);
...
CREATE TABLE `backlog_events` (
  ...
  `mcevent_type` int,
  `mcevent_start` datetime,
  `mcevent_end` datetime
);
...
ALTER TABLE `mc_halloween` ADD FOREIGN KEY (`mchall_activehouses`) REFERENCES `mc_hallhouses` (`id_mchallhouse`);
